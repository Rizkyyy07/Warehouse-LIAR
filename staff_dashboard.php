...
<body>
  ...
  <header class="animate__animated animate__fadeInDown">
    <div class="container">
      <h2 class="animate__animated animate__fadeIn">Dashboard Staff <span class="staff-badge">STAFF</span></h2>
      <div class="nav-links">
        <a href="transaksi.php" class="animate__animated animate__fadeIn animate__delay-1s">
          <i class="fas fa-exchange-alt"></i> Input Transaksi
        </a>
        ...
        <tbody>
          <?php if(mysqli_num_rows($barang) > 0) { ?>
            ...
            <tr class="animate__animated animate__fadeIn">
              ...
              <td><?= $row['nama'] ?></td>
              <td>
                <span class="status-badge <?= $row['stok'] > 10 ? 'status-in' : ($row['stok'] > 0 ? 'status-in' : 'status-out') ?>">
                  <?= $row['stok'] ?>
                </span>
              </td>
              <td><?= $row['satuan'] ?></td>
              <td>
                <?= $row['stok'] > 10 ? 'Aman' : ($row['stok'] > 0 ? 'Hampir Habis' : 'Kosong') ?>
              </td>
            </tr>
            <?php } ?>
          <?php } else { ?>
            <tr>
              <td colspan="5" class="empty-state">Tidak ada data barang</td>
            </tr>
          <?php } ?>
        </tbody>
      </table>
