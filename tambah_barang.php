...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $stok = $_POST['stok'];
  $satuan = $_POST['satuan'];
  mysqli_query($conn, "INSERT INTO barang (nama, stok, satuan) VALUES ('$nama', $stok, '$satuan')");
...
#satuan option[disabled][selected] {
  color: rgba(255, 255, 255, 0.4);
}
...
<body>
  ...
  <div class="warehouse-container">
    ...
    <div class="form-container animate__animated animate__fadeInUp">
      ...
      <h2 class="animate__animated animate__fadeIn">Tambah Barang</h2>
      <form method="POST">
      ...
      <a href="javascript:history.back()" class="back-link animate__animated animate__fadeIn animate__delay-2s">
